...
1. Save this spec to `.spec/spec-0001-second-k3s-node.md` in the repo.
2. Implement all Terraform and cloud-init changes described below.
3. After completing all work, create a provenance record at `.provenance/spec-0001-second-k3s-node.provenance.md`. See the **Provenance Record** section for the required format.
...
After completing the work, create `.provenance/spec-0001-second-k3s-node.provenance.md` with the following structure:
...
1. This spec has been saved to `.spec/spec-0001-second-k3s-node.md`
...
20. `pnpm lint` passes
21. The provenance record exists at `.provenance/spec-0001-second-k3s-node.provenance.md` and contains all required sections
