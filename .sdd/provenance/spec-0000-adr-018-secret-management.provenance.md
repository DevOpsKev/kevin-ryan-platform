...
4. Created directory `.spec/` and wrote spec file to `.spec/spec-0000-adr-018-secret-management.md`.
...
6. Created directory `.provenance/` and wrote this provenance record to `.provenance/spec-0000-adr-018-secret-management.provenance.md`.
...
| File | Status |
|------|--------|
| `.spec/spec-0000-adr-018-secret-management.md` | Created |
...
| # | Check | Result |
|---|-------|--------|
| 1 | Spec saved to `.spec/spec-0000-adr-018-secret-management.md` | Pass |
