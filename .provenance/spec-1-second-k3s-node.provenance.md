...
3. Created `.spec/spec-1-second-k3s-node.md` — saved the spec verbatim.
...
18. Created `.provenance/spec-1-second-k3s-node.provenance.md` (this file).
...
| File | Status |
|------|--------|
| `.spec/spec-1-second-k3s-node.md` | Created |
...
| `.provenance/spec-1-second-k3s-node.provenance.md` | Created |

## Validation Results

| # | Check | Result |
|---|-------|--------|
| 1 | `.spec/spec-1-second-k3s-node.md` exists | Pass |
