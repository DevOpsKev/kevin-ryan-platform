...
2. Created `.spec/spec-3a-fix-eso-crd-ordering.md` with the full spec content
...
7. Created `.provenance/spec-3a-fix-eso-crd-ordering.provenance.md` (this file)
...
| File | Status |
|------|--------|
| `.spec/spec-3a-fix-eso-crd-ordering.md` | Created |
...
| `.provenance/spec-3a-fix-eso-crd-ordering.provenance.md` | Created |

## Validation Results

1. `.spec/spec-3a-fix-eso-crd-ordering.md` exists — **PASS**
...
9. `.provenance/spec-3a-fix-eso-crd-ordering.provenance.md` exists with all required sections — **PASS**
